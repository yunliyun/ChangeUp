 ...
 */
 void opcontrol() {
  ...
  pros::lcd::set_text(0, "opcontrol has started!");
	...
	pros::Task RollerLower(RollerLower_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");
	pros::Task RollerUpper(RollerLower_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");
	pros::Task Claw(Claw_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My Task");

 	//while true loop - to keep the above tasks alive
 	while (true) {
